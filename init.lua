...
--    { nested = true, callback = function() pcall(vim.cmd.colorscheme, vim.g.SCHEME) end, })
...
require('packer').startup(function(use)
    ...
    local augroup = vim.api.nvim_create_augroup("MyColorschemeLoader", { clear = true })

    -- Create the autocommand
    vim.api.nvim_create_autocmd("VimEnter", {
        group = augroup,
        pattern = "*",
        callback = load_colour, -- Reference the function here
    })
    -- End Theme
